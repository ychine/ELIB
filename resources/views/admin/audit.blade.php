      ...
      <div class="hero-container relative w-full greenhue z-1">
        ...
        <div class="px-4 lg:px-[5%] pt-4">
          <div class="page-title-container active">
            <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold kulim-park-bold tracking-tight">Audit Trail</h2>
          </div>
        </div>
        <div class="px-4 lg:px-[5%] rounded-2xl bg-white shadow-lg p-6">
          ...
          @else
            <div class="overflow-x-auto">
              <table class="w-full kantumruy-pro-regular tracking-tight bg-white shadow rounded-lg mt-4 min-w-[800px]">
                <thead>
